...
PARAM <- list()
PARAM$experimento <- "HT7510_3"

PARAM$exp_input <- "TS7410_2"

# En caso que se haga cross validation, se usa esta cantidad de folds
PARAM$lgb_crossvalidation_folds <- 5

PARAM$lgb_semilla <- 103717 # cambiar por su propia semilla
...
PARAM$lgb_basicos <- list(
  ...
  min_gain_to_split = 0.03, # min_gain_to_split >= 0.0
  min_sum_hessian_in_leaf = 0.001, #  min_sum_hessian_in_leaf >= 0.0
  lambda_l1 = 100, # lambda_l1 >= 0.0
  lambda_l2 = 100, # lambda_l2 >= 0.0
