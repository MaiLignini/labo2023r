...
#  de los semmillerios
# El metodo ponder  pondera (multiplica) por la cantidad de semillas
#  de ese semillerio
...
PARAM <- list()
PARAM$experimento <- "HB7810_4"

# el inpput deben ser semillerios
PARAM$exp_input <- c("ZZ7710_1", "ZZ7710_7", "ZZ7710_12")
...
ImprimirGraficos <- function(tb_ganancias, semillerios_qty) {
  ...
  tb_ganancias[, gan_simple_suavizada := frollmean(
    x = ganancia_acum_simple,
